...
import 'zaposlenici_dodaj_uredi_screen.dart';

final zaposleniciStream = BehaviorSubject<int>.seeded(-1);

class ZaposleniciScreen extends StatefulWidget {
  static const String routeName = "/Zaposlenici";
  const ZaposleniciScreen({super.key});
        ...
        children: [
          ...
          ElevatedButton(
            onPressed: () async {
              Navigator.of(context).push(
                MaterialPageRoute(
                  builder: (context) => ZaposleniciDodajUrediScreen(
    ...
    return Expanded(
      ...
      child: SizedBox(
        ...
        child: StreamBuilder<Object>(
            stream: zaposleniciStream.stream,
...
class _DataSource extends DataTableSource {
  ...
  DataRow? getRow(int index) {
    ...
    return DataRow(
        onLongPress: () {},
        selected: index == zaposleniciStream.value ? true : false,
        onSelectChanged: (selected) {
          KorisnikData.korisnik = e;
          zaposleniciStream.add(index);
        },
